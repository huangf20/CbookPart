...
public class BannerModuleBean extends ModuleBean{
    ...
    public BannerModuleBean(int id, String type, String title, String channel, boolean showMore, String showType, int showNum, int startTime, int endTime, String linkUrl, boolean canDownload, boolean countDownNotShow, String btn, String targetType, ArrayList<BannerItemBean> items, String canReceiveTimes) {
